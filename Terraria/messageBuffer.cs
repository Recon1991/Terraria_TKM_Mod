									...
									else
									{
										if (b == 10 && Main.netMode == 1)
										{
											...
											for (int num19 = num17; num19 < num17 + (int)num16; num19++)
											{
                                                ...
                                                if ((b5 & 32) == 32)
                                                {
                                                    Main.tile[num19, num18].portal = true;
                                                }
                                                else
                                                {
                                                    Main.tile[num19, num18].portal = false;
                                                }
                                                ...
                                                //Mod: portal functionality
                                                if (Main.tile[num19, num18].portal)
                                                {
                                                    Main.tile[num19, num18].portalPartner.X = BitConverter.ToInt32(this.readBuffer, num);
                                                    num += 4;
                                                    Main.tile[num19, num18].portalPartner.Y = BitConverter.ToInt32(this.readBuffer, num);
                                                    num += 4;
                                                }
											}
											if (Main.netMode == 2)
																...
																else
																{
																	if (b == 17)
																	{
																		...
																		if (b7 == 0)
																		{
                                                                            ...
                                                                            //Mod for indestructable tiles
                                                                            if (Main.netMode == 2 && num29 > WorldGen.minStrongTilesX && num29 < WorldGen.maxStrongTilesX && num30 > WorldGen.minStrongTilesY && num30 < WorldGen.maxStrongTilesY && WorldGen.noKillStrongTiles) //Mod
                                                                            {
                                                                                NetMessage.SendData(0x11, this.whoAmI, -1, "", 1, (float)num29, (float)num30, (float)Main.tile[num29, num30].type, 0);
                                                                            }
																		}
																		else
																		{
																			...
																			{
                                                                                //Mod: Portal functionality
                                                                                if (this.whoAmI >= 0 && (int)b8 == 254)
                                                                                {
                                                                                    if (Main.player[this.whoAmI].lastPortalMadeX >= 0)
                                                                                    {
                                                                                        Main.tile[num29, num30].portalPartner.X = Main.player[this.whoAmI].lastPortalMadeX;
                                                                                        Main.tile[num29, num30].portalPartner.Y = Main.player[this.whoAmI].lastPortalMadeY;
                                                                                        Main.tile[Main.player[this.whoAmI].lastPortalMadeX, Main.player[this.whoAmI].lastPortalMadeY].portalPartner.X = num29;
                                                                                        Main.tile[Main.player[this.whoAmI].lastPortalMadeX, Main.player[this.whoAmI].lastPortalMadeY].portalPartner.Y = num30;
                                                                                        Main.player[this.whoAmI].lastPortalMadeX = -1; //for new portals
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        Main.player[this.whoAmI].lastPortalMadeX = num29;
                                                                                        Main.player[this.whoAmI].lastPortalMadeY = num30;
                                                                                    }
                                                                                }
																			...
																			else
																			{
																				if (b7 == 2)
																				{
                                                                                    ...
                                                                                    if (Main.netMode == 2 && num29 > WorldGen.minStrongTilesX && num29 < WorldGen.maxStrongTilesX && num30 > WorldGen.minStrongTilesY && num30 < WorldGen.maxStrongTilesY && WorldGen.noKillStrongTiles) //Mod
                                                                                    {
                                                                                        NetMessage.SendData(0x11, this.whoAmI, -1, "", 3, (float)num29, (float)num30, (float)Main.tile[num29, num30].type, 0);
                                                                                    }
																				}
																				else
																				{
																		...
																		if (Main.netMode == 2)
																		{
                                                                            if (b7 == 0 || b7 == 2 || b7 == 4)
                                                                            {
                                                                                if (!(num29 > WorldGen.minStrongTilesX && num29 < WorldGen.maxStrongTilesX && num30 > WorldGen.minStrongTilesY && num30 < WorldGen.maxStrongTilesY && WorldGen.noKillStrongTiles)) //Mod
                                                                                {
                                                                                    NetMessage.SendData(0x11, -1, this.whoAmI, "", b7, (float)num29, (float)num30, (float)b8, 0);
                                                                                }
                                                                            }
                                                                            else
                                                                                NetMessage.SendData(0x11, -1, this.whoAmI, "", b7, (float)num29, (float)num30, (float)b8, 0);
																				...
																				if (b == 20)
																				{
																					...
																					for (int num39 = num37; num39 < num37 + (int)num36; num39++)
																					{
																						for (int num40 = num38; num40 < num38 + (int)num36; num40++)
																						{
                                                                                            ...
                                                                                            if ((b11 & 32) == 32)
                                                                                            {
                                                                                                Main.tile[num39, num40].portal = true;
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                Main.tile[num39, num40].portal = false;
                                                                                            }
                                                                                            ...
                                                                                            //Mod: portal functionality
                                                                                            if (Main.tile[num39, num40].portal)
                                                                                            {
                                                                                                Main.tile[num39, num40].portalPartner.X = BitConverter.ToInt32(this.readBuffer, num);
                                                                                                num += 4;
                                                                                                Main.tile[num39, num40].portalPartner.Y = BitConverter.ToInt32(this.readBuffer, num);
                                                                                                num += 4;
                                                                                            }
																						}
																					}
																								...
																								if (b == 25)
																								{
																									...
																									if (Main.netMode == 2)
																									{
																										...
																										if (text2 == "/playing")
																										{
																											...
																											{
																												if (Main.player[num29].active)
																												{
																													if (text3 == "")
																													{
																														text3 += Main.player[num29].name;
																													}
																													else
																													{
																														text3 = text3 + ", " + Main.player[num29].name;
																													}
																												}
																											}
																										...
																										if (text2.Length >= 3 && text2.Substring(0, 3) == "/p ")
																										{
																											if (Main.player[this.whoAmI].team != 0)
																											{
																												...
																												{
																													if (Main.player[num30].team == Main.player[this.whoAmI].team)
																													{
																														NetMessage.SendData(25, num30, -1, string3.Substring(3), num52, (float)Main.teamColor[Main.player[this.whoAmI].team].R, (float)Main.teamColor[Main.player[this.whoAmI].team].G, (float)Main.teamColor[Main.player[this.whoAmI].team].B, 0);
																													}
																												}
																												return;
																											}
																										...
																										else
																										{
                                                                                                            ...
                                                                                                            string sendString = string3;

                                                                                                            //Mod
                                                                                                            if (string3.Length >= 5)
                                                                                                            {
                                                                                                                if ((string3.Substring(0, 4) == "/pw:"))
                                                                                                                {
                                                                                                                    for (int i = 4; i < string3.Length; i++)
                                                                                                                    {
                                                                                                            ...
                                                                                                            if (string3.Length >= 7) //Mod
                                                                                                            {
                                                                                                                if ((string3.Substring(0, 7) == "/setpw:"))
                                                                                                                {
                                                                                                                    for (int i = 7; i < string3.Length; i++)
                                                                                                                    {
                                                                                                                        sendString = sendString.Remove(i, 1);
                                                                                                                        sendString = sendString.Insert(i, "*");
                                                                                                                    }
                                                                                                            ...
                                                                                                            NetMessage.SendData(25, -1, -1, sendString, num52, (float)b15, (float)b16, (float)b17, 0);
																											...
																											if (Main.dedServ)
																											{
                                                                                                                ...
                                                                                                                if (string3[0] == '/')
                                                                                                                {
                                                                                                                    if (string3 == "/pw:" + Main.adminPassword)
                                                                                                                    {
                                                                                                                    ...
                                                                                                                    if (Main.player[this.whoAmI].admin)
                                                                                                                    {
                                                                                                                        if (string3.Length >= 7)
                                                                                                                        {
                                                                                                                            if ((string3.Substring(0, 7) == "/setpw:"))
                                                                                                                            {
                                                                                                                                Console.WriteLine(Main.player[this.whoAmI].name + " changed the password to " + string3.Substring(7));
                                                                                                                                Main.adminPassword = string3.Substring(7);
                                                                                                                            }
                                                                                                                        }
                                                                                                                        if ((string3.Length >= 6) && (string3.Substring(0, 6) == "/kick "))
                                                                                                                        {
                                                                                                                            string kickName = string3.Substring(6).ToLower();
                                                                                                                        ...
                                                                                                                        if ((string3.Length >= 5) && (string3.Substring(0, 5) == "/ban "))
                                                                                                                        {
                                                                                                                            string banName = string3.Substring(5).ToLower();
                                                                                                                        ...
                                                                                                                        switch (string3)
                                                                                                                        {
                                                                                                                            case "/hard_spawn_rate":
                                                                                                                                {
                                                                                                                                    NPC.defaultSpawnRate = 300;
                                                                                                                                    NPC.defaultMaxSpawns = 100;
                                                                                                                                    break;
                                                                                                                                }
                                                                                                                            case "/easy_spawn_rate":
                                                                                                                                {
