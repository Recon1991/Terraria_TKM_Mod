												...
												else
												{
													if (msgType == 10)
													{
														...
														for (int i = num5; i < num5 + (int)num4; i++)
														{
                                                            ...
                                                            if (Main.tile[i, num6].portal)
                                                            {
                                                                Int32 portalX = (Int32)Main.tile[i, num6].portalPartner.X;
                                                                Int32 portalY = (Int32)Main.tile[i, num6].portalPartner.Y;

                                                                Buffer.BlockCopy(BitConverter.GetBytes(portalX), 0, buffer[num].writeBuffer, num3, 4);
                                                                num3 += 4;
                                                                Buffer.BlockCopy(BitConverter.GetBytes(portalY), 0, buffer[num].writeBuffer, num3, 4);
                                                                num3 += 4;
                                                            }
														}
