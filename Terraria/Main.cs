...
namespace Terraria
{
	public class Main : Game
	{
		...
		public const int maxProjectileTypes = 500; //Mod
		...
		public static string[] tileName = new string[0xff]; //Mod
		...
		public static int[] projFrames = new int[500]; //Mod
        ...
        public static Texture2D[] itemTexture = new Texture2D[0x1000]; //Mod
		public static Texture2D[] npcTexture = new Texture2D[147];
		public static Texture2D[] projectileTexture = new Texture2D[500]; //Mod: added more projectiles
		...
		public static Texture2D[] tileTexture = new Texture2D[0xff]; //Mod
		...
		public static bool[] tileLighted = new bool[0xff];
		public static bool[] tileMergeDirt = new bool[0xff];
		...
		public static bool[] tileShine2 = new bool[0xff];
		public static bool[] wallHouse = new bool[32];
		public static int[] wallBlend = new int[32];
		public static bool[] tileStone = new bool[0xff];
		public static bool[] tilePick = new bool[0xff];
		public static bool[] tileAxe = new bool[0xff];
		public static bool[] tileHammer = new bool[0xff];
		...
		public static bool[] tileNoSunLight = new bool[0xff];
		...
		public static string[] itemName = new string[0x1000]; //Mod
        ...
        public static int minAddedItems = 4094;
        public static int maxAddedItems = 4095;
        public static int minAddedProjectiles = 499;
        public static int maxAddedProjectiles = 499;
			...
			while (!Netplay.disconnect)
			{
				...
				try
				{
                    ...
                    if (text == "spawn_destroyer")
                    {
                        ...
                        NPC.NewNPC(((int)position2.X), ((int)position2.Y), 134, 0);

                        break;
                    }

                        if (text == "goblin_invasion")
                            {
                                Main.StartInvasion();
                                break;
                            }

                        if (text == "spawn_demon_eye")
                            {
                                Vector2 position2;
		...
		protected override void Initialize()
		{
            ...
            for (int num10 = 0; num10 < 0x1000; num10++) //Mod
			{
                if (num10 < 603 || (num10 >= minAddedItems && num10 <= maxAddedItems)) //Mod
                {
                    Item item = new Item();
		...
		protected override void LoadContent()
		{
            ...
            for (int num = 0; num < 0xff; num++) //Mod
			{
                if (num < 150 || (num >= minAddedTiles && num <= maxAddedTiles)) //Mod
			...
			for (int num5 = 0; num5 < 0x1000; num5++) //Mod
			{
                if (num5 < 603 || (num5 >= minAddedItems && num5 <= maxAddedItems)) //Mod
			...
			for (int num8 = 0; num8 < 500; num8++) //Mod
			{
                if (num8 < 111 || (num8 >= minAddedProjectiles && num8 <= maxAddedProjectiles)) //Mod
		...
		public static void StartInvasion(int type = 1)
		{
			...
			if (Main.invasionType == 0 && Main.invasionDelay == 0)
			{
				...
				if (num > 0)
				{
					...
					Main.invasionSize = 200 + 80 * num; //Mod
					Main.invasionWarn = 0;
