...
namespace Terraria
{
	public class Projectile
	{
								...
								else
								{
									...
									else
									{
										...
										else
										{
                                            ...
                                            //original purification powder values
                                            /*if (this.type == 10)
                                            {
                                                this.name = "Purification Powder";
                                                this.width = 64;
																...
																else
																{
																	if (this.aiStyle == 16)
																	{
																		...
																		if (this.owner == Main.myPlayer && this.timeLeft <= 3)
																		{
																			...
																			{
																				if (this.type == 29 || this.type == 499) //Mod
																				{
																					this.position.X = this.position.X + (float)(this.width / 2);
																					this.position.Y = this.position.Y + (float)(this.height / 2);
																					this.width = 250;
		...
		public void Kill()
		{
			...
			if (this.owner == Main.myPlayer)
			{
				if (this.type == 28 || this.type == 29 || this.type == 37 || this.type == 75 || this.type == 108 || this.type == 499) //Mod
				{
					int num81 = 3;
                    if (this.type == 29)
                    {
                    ...
                    if (this.type == 499) //Mod: Enchanted Dynamite
                    {
                        num81 = 30;
                    }
					if (this.type == 108)
